...
$("launch").onclick=()=>guard(async()=>{await api(phonePath()+"/launch",{app:$("app").value});await capture();say("Launch requested. Check the preview for login or setup prompts.");},$("launch"));
